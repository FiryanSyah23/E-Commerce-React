				...
				<div className="checkout-grid">
					<div className="order-summary">
						{deliveryOption.length > 0 &&
							cart.map((cartItem) => {
								const selectDeliveryOption = deliveryOption.find((itemDeliveryOption) => {
									return itemDeliveryOption.id === cartItem.deliveryOptionId;
								});

								return (
									<div className="cart-item-container" key={cartItem.productId}>
										<div className="delivery-date">Delivery date: {dayjs(selectDeliveryOption.estimatedDeliveryTimeMs).format("dddd, MMMM D")}</div>
										...
										<div className="cart-item-details-grid">
											...
											<div className="delivery-options">
												...
												{deliveryOption.map((item) => {
													...
													return (
														<div className="delivery-option" key={item.id}>
															<input
																type="radio"
															...
															/>
															<div>
																<div className="delivery-option-date">{dayjs(item.estimatedDeliveryTimeMs).format("dddd, MMMM DD")}</div>
